...
import com.baimeng.bmcore.utils.RegKit;
import com.baimeng.bmservice.impl.BStoreService;
import com.baimeng.bmservice.impl.BSysUserAuthService;
import com.baimeng.bmservice.impl.BSysUserService;
import com.baimeng.bmservice.model.BStore;
import com.baimeng.bmservice.model.BSysUser;
import com.baimeng.bmservice.model.BSysUserAuth;
...
public class JeeUserDetailsServiceImpl implements UserDetailsService {
    ...
    @Resource
    private BSysUserService iSysUserService;

    @Resource
    private BSysUserAuthService iSysUserAuthService;
    @Resource
    ...
    public UserDetails loadUserByUsername(String loginUsernameStr) throws UsernameNotFoundException {
        ...
        //用户ID
        Integer userId = auth.getSysUserId();
