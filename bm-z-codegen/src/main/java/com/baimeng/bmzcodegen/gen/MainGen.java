package com.baimeng.bmzcodegen.gen;
...
public class MainGen {
    ...
    public static final String THIS_MODULE_NAME = "bm-service"; //当前项目名称

    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/bm?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8";
    public static final String DB_USERNAME = "root";
    public static final String DB_PASSWORD = "";
    // 多个用,  拼接
    public static final String TABLE_NAMES = "b_examine";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.baimeng.bmservice");  //根目录
